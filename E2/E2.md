...
![e2p1](D:\SoftwarePractice\E2\E2.assets\e2p1.png)

### 1.编译生成应用

第一次Build Android应用，将会下载必要的gradle，wrappers和依赖库（需要时间依网络而定)

![e2p2](D:\SoftwarePractice\E2\E2.assets\e2p2.png)

### 2.创建虚拟设备（模拟器）

Android Studio支持虚拟设备（模拟器）的创建以运行应用程序

![e2p3](D:\SoftwarePractice\E2\E2.assets\e2p3.png)

### 3.应用程序运行效果图

![e2p4](D:\SoftwarePractice\E2\E2.assets\e2p4.png)
...
![e2p5](D:\SoftwarePractice\E2\E2.assets\e2p5.png)
...
![e2p6](D:\SoftwarePractice\E2\E2.assets\e2p6.png)
...
![e2p7](D:\SoftwarePractice\E2\E2.assets\e2p7.png)

或者在属性面板的Constraint Widget中移动光标到相应约束点击删除

![e2p8](D:\SoftwarePractice\E2\E2.assets\e2p8.png)

### 4.添加新的约束

添加Next的右边和底部约束至父类屏幕（如果不存在的话），Next的Top约束至TextView的底部。最后，TextView的底部约束至屏幕的底部。效果看起来如下图所示：

![e2p9](D:\SoftwarePractice\E2\E2.assets\e2p9.png)
...
![e2p10](D:\SoftwarePractice\E2\E2.assets\e2p10.png)

弹出对话框，令资源名为toast_button_text，资源值为Toast，并点击OK。

![e2p11](D:\SoftwarePractice\E2\E2.assets\e2p11.png)
...
![e2p12](D:\SoftwarePractice\E2\E2.assets\e2p12.png)
...
![e2p13](D:\SoftwarePractice\E2\E2.assets\e2p13.png)
...
![e2p14](D:\SoftwarePractice\E2\E2.assets\e2p14.png)
...
![e2p15](D:\SoftwarePractice\E2\E2.assets\e2p15.png)
 ...
 ![e2p16](D:\SoftwarePractice\E2\E2.assets\e2p16.png)

### 10.运行应用程序

查看效果：

![e2p17](D:\SoftwarePractice\E2\E2.assets\e2p17.png)
...
Android Studio中，依次点击File>New Projects Settings>Settings for New Projects…，查找Auto Import选项，在Java和Kotlin部分，勾选Add Unambiguous Imports on the fly。
 ...
 ![e2p18](D:\SoftwarePractice\E2\E2.assets\e2p18.png)
...
效果如下：
 ...
 ![e2p19](D:\SoftwarePractice\E2\E2.assets\e2p19.png)

## 三、完成第二界面的代码

 此步骤将完成按照First Fragment显示数字作为上限，随机在Second Fragment上显示一个数字，即Random按钮的事件响应。效果如下：

 ![e2p20](D:\SoftwarePractice\E2\E2.assets\e2p20.png)
...
![e2p21](D:\SoftwarePractice\E2\E2.assets\e2p21.png)
...
![e2p22](D:\SoftwarePractice\E2\E2.assets\e2p22.png)
...
![e2p23](D:\SoftwarePractice\E2\E2.assets\e2p23.png)
...
![e2p24](D:\SoftwarePractice\E2\E2.assets\e2p24.png)
...
![e2p25](D:\SoftwarePractice\E2\E2.assets\e2p25.png)
![e2p26](D:\SoftwarePractice\E2\E2.assets\e2p26.png)
